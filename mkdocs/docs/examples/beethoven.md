...
% measure 5
		\slurBegin:2<"up", dy1=1, dy2=6> \turn<dx=5, dy=-2>(\fing<"3", dy=-4>(a/4)) 
		\slurEnd:1 
...
% measure 9
		...
		\fing<"3", dy=-6>(f) a c1 a0
% measure 9
		\fing<"4", dy=-5>(e) \slurEnd g c1 g0 e g c1 g0 f a c1 a0
% measure 10
		g b& c1 b&0 g b& c1 b&0 \fing<"2", dy=-5>(a) c1 a0 f
		|
	],
	[
